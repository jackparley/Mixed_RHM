...
#SBATCH --job-name mixed_rhm_v_16_f_34_L_2_T1_double_sharing_65536  # Assign unique name
...
OUTNAME="dynamics_v_16_f_34_L_2_d_5_set_P_${insert_train}_${SLURM_ARRAY_TASK_ID}.pkl"
